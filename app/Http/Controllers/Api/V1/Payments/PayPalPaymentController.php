...
final class PayPalPaymentController
{
        ...
        try {
            ...
            Log::warning(
                ...
                [
                    ...
                    'paypal_status_code' => $exception->statusCode,
            ...
            return response()->json([
                ...
                'message' => 'No fue posible iniciar el pago con PayPal.',

                'error' => [
                    'code' => $exception->paypalErrorName
                        ?? 'PAYPAL_CREATE_ORDER_ERROR',

                    'recoverable' => $this->isRecoverableStatus(
    ...
    public function show(
        ...
        return (new PayPalPaymentStatusResource($payment))
            ->additional([
                'message' => 'Estado del pago PayPal consultado correctamente.',
            ]);
    }
    ...
    public function capture(
        ...
        try {
            ...
            return (new OrderResource($order))
                ->additional([
                    'message' => 'Pago confirmado y pedido creado correctamente.',
            ...
            Log::notice(
                ...
                [
                    ...
                    'paypal_error' => $exception->paypalCode,

                    'paypal_debug_id' => $exception->reference,
            ...
            return response()->json([
                ...
                'message' => 'No fue posible confirmar el pago con PayPal.',
    ...
    private function resolveHttpStatus(
        ...
        return match (true) {
            $paypalStatusCode === 408 => 504,

            $paypalStatusCode === 429 => 503,

            $paypalStatusCode !== null
                && $paypalStatusCode >= 500 => 502,

            $paypalStatusCode !== null
                && $paypalStatusCode >= 400 => 422,
