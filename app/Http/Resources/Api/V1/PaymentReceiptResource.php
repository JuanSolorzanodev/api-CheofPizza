    ...
    public function toArray(
        ...
        return [
            ...
            'order' => $this->whenLoaded(
                'order',
                fn (): ?array => $this->order === null
                        ? null
                        : [
                            'id' => (int) $this->order->id,

                            'order_number' => (string) $this->order
                                ->order_number,

                            'total' => (float) $this->order
                                ->total,

                            'ordered_at' => $this->order
                                ->ordered_at
                                ?->toISOString(),
            ...
            'file_available' => $this->hasStoredFile(),

            'file_url' => $this->hasStoredFile()
                    ? route(
            ...
            'file_deleted_at' => $this->file_deleted_at
                ?->toISOString(),
