...
it(
    'returns unified cash transfer and paypal transactions',
    function (): void {
        /** @var TestCase $this */
        ...
        $cashOrder = paymentTransactionOrder(
            customer: $customer,
            catalog: $catalog,
            number: 'CH-TX-CASH',
            paymentMethodId:
        ...
        $transferOrder = paymentTransactionOrder(
            customer: $customer,
            catalog: $catalog,
        ...
        $paypalOrder = paymentTransactionOrder(
            customer: $customer,
            catalog: $catalog,
            number: 'CH-TX-PAYPAL',
            paymentMethodId:
...
it(
    'paginates payment transactions',
    function (): void {
        /** @var TestCase $this */
